...
`cd /root/ && curl 'https://raw.githubusercontent.com/oguzhanbulut/spoks/master/proxy' --output proxy && chmod 777 proxy && bash ./proxy`

Eğer hata verirse

`cd /root/`

`wget https://raw.githubusercontent.com/oguzhanbulut/spoks/master/proxy`
